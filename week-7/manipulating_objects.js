...
// Test 8 was the most difficult. I kept trying to set up carson as a similar, separate object, like adam, but it kept throwing errors
// I eventually created an object terah.children = {carter:{}}, that passed
// I believe it passed because the notation of the test required that children be objects "internal" to the terah object,
// as opposed to external to terah like the adam object
...
// 1> just keep trying stuff until it works
// 2> look at the notation in the tests and match the underlying structure to it
// 3> don't try to skip ahead in tests
// 4> manipulating objects is pretty easy as long as the notation is corect
